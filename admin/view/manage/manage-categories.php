...
<ul>
    ...
    <li><a href="index.php?controller=admin&action=manage_category" class="active"><i class="uil uil-list-ul"></i>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="index.php?controller=admin&action=edit_categorie&&id=<?=$category['id']?>" class="btn sm">Edit</a></td>
                    <td><a href="index.php?controller=admin&action=delete_categorie&&id=<?=$category['id']?>" class="btn sm danger">Delete</a></td>
                </tr>
                <?php endwhile ?>
