...
public static function getbyid($id){
    ...
    public static function exist($username,$email){
        $db = App::getDB();
        $fetch_user_query = "SELECT * FROM user WHERE username='$username' OR email='$email' ";
        ...
        public static function getnot($current_admin_id){
            $db = App::getDB();
        ...
        public static function check_available($username,$email){
                ...
                $resultat = $db->execute_query($user_check_query);
                if(!$resultat) {
                echo "Lecture impossible";
                }
                else{
